...
Based on [lecture](https://www.youtube.com/watch?v=zduSFxRajkE)
...
Add the ability to handle special tokens. You'll then be able to match the output of tiktoken even when special tokens are present, e.g.:
